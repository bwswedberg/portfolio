...
var projects = [{
  ...
  //   src: '/projects/apartment-reporter/apartment-reporter-3.png',
  //   caption: 'My caption',
  // },
  {
    src: '/projects/apartment-reporter/apartment-reporter-4.png',
    caption: 'The frontend interface of *Apartment Reporter*. Filtering apartment listings by date range.'
  }, // { 
  //   src: '/projects/apartment-reporter/apartment-reporter-5.png',
  //   caption: 'My caption',
  // },
  // { 
  //   src: '/projects/apartment-reporter/apartment-reporter-6.png',
  //   caption: 'My caption',
  // },
  {
    src: '/projects/apartment-reporter/apartment-reporter-7.png',
    caption: 'The frontend interface of *Apartment Reporter*. Filtering apartment listings by room number and monthly rent price'
  }]
}, {
  id: 'data-viz',
  ...
  description: 'Data visualizations are a great deal of fun for testing ideas and showing off techniques. <a href="https://bl.ocks.org/bwswedberg">Bl.ocks</a> are ObservableHQ is an enviroment perfect for that.',
  ...
  images: [{
    ...
    caption: '<a href="https://bl.ocks.org/bwswedberg/93cb6fea2dd3d653727e01b2db967dba">Circular Fractal</a> is an experimental vizualization using trigonometry and fractals.'
  }, {
    src: '/projects/data-viz/collapsible-tree-w-minimap.png',
    caption: '<a href="https://bl.ocks.org/bwswedberg/464a7dbc471ee2a94dd6278bc7d94710">Collapsible Tree with Minimap</a> is a proof-of-concept data visualization to demo minimap capability for tree visualizations.'
  }, {
    src: '/projects/data-viz/facebook-friends.png',
    caption: '<a href="http://bl.ocks.org/bwswedberg/8d7061442cdf3e1b7ed7">My Facebook Friends</a> is a data visualization showing my actual Facebook friends and their Facebook connections.'
  }, {
    src: '/projects/data-viz/filled-donut-chart.png',
    caption: '<a href="https://bl.ocks.org/bwswedberg/bec2f9531578441a82413ca2854b1593">Filled Donut Chart</a> is an experimental data visualization where the fill of the donut is somewhat proportional to a value. This chart was inspired by water filling up a glass.'
  }, {
    src: '/projects/data-viz/satellite-1.png',
    caption: 'A series of satellite map proof-of-concepts that demonstrate how to map real satellites using a variety of libraries. Simple to complex: <a href="https://bl.ocks.org/bwswedberg/645f73c77b76913bea5b19e6ebce1204">Satellite Map Using Leaflet</a>, <a href="https://bl.ocks.org/bwswedberg/c4a444ebf27fd08bb4339e8e77c9d986">Satellite Map Using Leaflet with Wrapping</a>, <a href="https://bl.ocks.org/bwswedberg/d7d6eaedc2c501dc5f5e4be649b0da1d">Satellite Map Using Leaflet + D3 with Wrapping</a>, and finally <a href="https://bl.ocks.org/bwswedberg/29bda412413335b705c434e8a0af1f50">Satellite Map Using Three.js with Zoom and Pan</a>.'
  }, {
    src: '/projects/data-viz/world-wrap-click-to-zoom.png',
    caption: '<a href="https://bl.ocks.org/bwswedberg/da180a7f413d9fa47495482e99a56b9b">World Wrapping Map w/ Click-to-Zoom</a> is a proof-of-concept map that shows how to reconcile infinite panning with click-to-zoom.'
  }]
}, {
  id: 'perse',
  type: 'Data Visualization',
...
//# sourceMappingURL=index.js.74678004bbdbb42c5b63.hot-update.js.map